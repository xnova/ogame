...
const shipyard = {
  ...
  resolve({ planet }) {
    ...
    return {
      ...
      longDescription: 'The planetary shipyard is responsible for the construction of spacecraft and defensive mechanisms. ' +
      'As the shipyard is upgraded, it can produce a wider variety of vehicles at a much greater rate of speed. ' +

...
const roboticsFactory = {
  ...
  resolve({ planet }) {
    ...
    return {
      ...
      description: 'Robotic factories provide construction robots to aid in the construction of buildings. ' +
      'Each level increases the speed of the upgrade of buildings.',
      longDescription: 'The Robotics Factory primary goal is the production of State of the Art construction robots. ' +
